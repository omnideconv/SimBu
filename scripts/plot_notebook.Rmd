...
cell_types <- c("Monocytes", "NK cells", "T CD8 memory", "T cells CD4","T cells CD8","B Naive" ,"T CD4 Memory","MAIT" ,"T gd Vd2" ,"Neutrophils" ,"T gd non-Vd2" ,"Basophils LD"   ,"Monocytes NC+I" ,"B cells"   ,"mDCs"   ,"pDCs" ,"Plasmablasts"   ) 
...
data_lst <- list(maynard_f, quantiseq_f, epic_f, miltenyi_f, vento_tormo_f, monaco_f)
...
c1 <- c(rep(sources[1],5), rep(sources[2],4), rep(sources[3],3), rep(sources[4],2), rep(sources[5],1))
c2 <- c("quantiseq", "epic", "miltenyi", "vento_tormo","monaco", "epic", "miltenyi", "vento_tormo", "monaco", "miltenyi", "vento_tormo", "monaco", "vento_tormo", "monaco", "monaco")
