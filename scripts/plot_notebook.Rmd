...
```{r}
suppressWarnings(source("transform_scaling_factors.R"))
...
wanted_types2 <- data.frame(type=c("B cells", "T cells", "T cells CD4", "T cells CD8", "Monocytes", "Macrophages", "NK cells", "Dendritic cells", "Fibroblasts", "Neutrophils"))

full <- combine_all(with_ercc = F, wanted_types = wanted_types2)
```
...
png(filename="../plots/scaling_factors_scatter.png", width=5000, height=3000)
...
png(filename="/home/simulator/plots/census_correlation_reduced.png", width = 1200, height = 1200)
corrplot(corr,
         tl.col = "black",
