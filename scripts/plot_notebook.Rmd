...
meta$cell_type <- gsub("dNK1", "decidual natural killer cells", meta$cell_type)
meta$cell_type <- gsub("dNK2", "decidual natural killer cells", meta$cell_type)
meta$cell_type <- gsub("dNK3", "decidual natural killer cells", meta$cell_type)
meta$cell_type <- gsub("dNK p", "decidual natural killer cells", meta$cell_type)
meta$cell_type <- gsub("dM1", "decidual macrophages", meta$cell_type)
meta$cell_type <- gsub("dM2", "decidual macrophages", meta$cell_type)
meta$cell_type <- gsub("dM3", "decidual macrophages", meta$cell_type)
...
#png(filename="Data/Vento-Tormo/Vento-Tormo_celltypes.png", width=800, height=600)
...
png(filename="Data/Maynard/Maynard_celltypes.png", width=1800, height=1200)
...
miltenyi <- data.frame(type=c("B cells", "Hematopoietic progenitor cells", "Monocytes", "Myeloid dendritic cells", "Plasmacytoid dendritic cell","NK cells", "NKT cells", "T cells", "T helper cells", "Cytotoxic T cells", "T regulatory cells"),
...
wanted_types <- data.frame(type=c("B cells", "T cells", "T cells CD4", "T cells CD8","Monocytes", "Macrophages", "NK cells", "T regulatory cells", "Fibroblasts"))
...
png(filename="Data/scaling_factors.png", width=1800, height=1200)
...
ggplot(full, aes(x=source, y=mRNA, fill=source))+
  ...
  theme(axis.text.x = element_text(angle = 90))+
  ylab("Scaling factor")+
  ggtitle("Different scaling factors (all re-scaled to reference cell-type Monocytes)\n for mRNA levels of 9 cell-types")
```