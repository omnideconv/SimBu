...
load_maynard <- function(){
  maynard_reads_fractions <- fread("../../Data/Maynard/read_count_per_cell_type.csv")
  ...
  tpm <- fread("../../Data/Maynard/datasets_annotated/maynard_2020_annotated_fine/X_tpm.csv")
  mat <- Matrix(as.matrix(tpm), sparse = T)
  rm(tpm)
  genes <- fread("../../Data/Maynard/datasets_annotated/maynard_2020_annotated_fine/var.csv")
  cells <- fread("../../Data/Maynard/datasets_annotated/maynard_2020_annotated_fine/obs.csv")
  cellnames <- cells$Run
...
load_vento_tormo <- function(){
  meta_runs <- fread("../../Data/Vento-Tormo/filereport_read_run_PRJEB25794_tsv.txt")[,c("library_name","read_count","run_accession")]
  meta_cells <- fread("../../Data/Vento-Tormo/meta_ss2.txt")[,c("V1","annotation")]
  vento_census <- fread("../../Data/Vento-Tormo/census_vento_tormo.tsv")
