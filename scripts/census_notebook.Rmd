...
```{r}
census_mean_counts <-df[,mean(census_counts),by=celltype.l1]
census_mean_counts$source <- "census (mean)"
colnames(census_mean_counts) <- c("type","mRNA","source")
census_mean_counts$type <- c("T cells CD8","B cells","T cells CD4","Monocytes", "other", "NK cells", "Dendritic cells", "other T")
census_median_counts <-df[,median(census_counts),by=celltype.l1]
census_median_counts$source <- "census (median)"
colnames(census_median_counts) <- c("type","mRNA","source")
census_median_counts$type <- c("T cells CD8","B cells","T cells CD4","Monocytes", "other", "NK cells", "Dendritic cells", "other T")
