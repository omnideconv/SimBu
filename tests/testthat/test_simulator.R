...
test_that('test different scaling factor calculations + mRNA bias removal from counts', {
  ...
  testthat::expect_s4_class(SimBu::simulate_bulk(data = dataset, scenario = 'random', scaling_factor = 'census', nsamples = 10, ncells = 100, ncores = 1)[['bulk']], 'SummarizedExperiment')
