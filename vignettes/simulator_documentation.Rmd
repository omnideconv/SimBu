...
```{r}
counts <- matrix(rpois(3e5, 5), ncol=300)
tpm <- matrix(rpois(3e5, 5), ncol=300)
tpm <- tpm / sum(tpm) *1e6 
...
dimensions and have to contain the same genes and cells. You can also supply only a single matrix.\
